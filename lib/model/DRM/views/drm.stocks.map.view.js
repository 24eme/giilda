                         ...
                         for(couleur_key in lieu.couleurs) {
                             ...
                             for(cepage_key in couleur.cepages) { 
                                ...
                                for(detail_key in cepage.details) { 
                                    ...
                                    emit([doc.campagne, societe, doc.identifiant, hash, doc.periode, doc.version], [cepage.total_debut_mois, cepage.total_entrees, cepage.total_recolte, cepage.total_sorties, cepage.total_facturable, cepage.total, doc.declarant.nom, detail.produit_libelle]);
                                    break;
                                } 
                } // Boucle cepage
                         } // Boucle couleur
