                        ...
                        for(couleur_key in lieu.couleurs) {
                            ...
                            for(cepage_key in couleur.cepages) { 
                                ...
                                for(detail_key in cepage.details) {
                                    ...
                                    volume_revendique += detail.entrees.recolte;
                                }
                                emit([doc.campagne, societe, doc.identifiant, hash, doc.periode, doc.version], [cepage.total_debut_mois, volume_revendique, cepage.total_entrees, cepage.total_sorties, cepage.total, doc.declarant.nom, null]);
                            } // Boucle cepage
                        } // Boucle couleur
                    } // Boucle lieu
                } // Boucle mention
