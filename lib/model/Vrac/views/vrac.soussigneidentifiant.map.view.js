function(doc) {
  	...
  	emit(["TYPE", doc.mandataire_identifiant, doc.type_transaction],  [doc.campagne, doc.valide.statut, doc._id, doc.numero_contrat, doc.acheteur_identifiant, doc.acheteur.nom, doc.vendeur_identifiant, doc.vendeur.nom, doc.mandataire_identifiant,doc.mandataire.nom, doc.type_transaction, doc.produit, doc.volume_propose, doc.volume_enleve]);
  	
  	emit(["TYPE", doc.acheteur_identifiant, doc.type_transaction], [doc.campagne, doc.valide.statut, doc._id, doc.numero_contrat, doc.acheteur_identifiant, doc.acheteur.nom, doc.vendeur_identifiant, doc.vendeur.nom, doc.mandataire_identifiant,doc.mandataire.nom, doc.type_transaction, doc.produit, doc.volume_propose, doc.volume_enleve]);
  	
  	emit(["TYPE", doc.vendeur_identifiant, doc.type_transaction], [doc.campagne, doc.valide.statut, doc._id, doc.numero_contrat, doc.acheteur_identifiant, doc.acheteur.nom, doc.vendeur_identifiant, doc.vendeur.nom, doc.mandataire_identifiant,doc.mandataire.nom, doc.type_transaction, doc.produit, doc.volume_propose, doc.volume_enleve]);
}