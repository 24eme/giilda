...
class DRMDetailCooperativeItemForm extends DRMESDetailsItemForm {
    ...
    public function configure() {
        parent::configure();
        $this->setWidget('identifiant', new WidgetEtablissement(array('interpro_id' => 'INTERPRO-declaration', 'familles' => array(EtablissementFamilles::PSEUDOFAMILLE_COOPERATIVE))));
