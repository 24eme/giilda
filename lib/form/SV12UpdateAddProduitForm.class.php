  ...
  public function __construct(SV12 $sv12, $options = array(), $CSRFSecret = null) 
  {
    ...
    public function configure() 
    {
      $this->setWidgets(array(
			      ...
			      'raisinetmout' => new sfWidgetFormChoice(array('choices' => array(VracClient::TYPE_TRANSACTION_RAISINS => 'Raisons', VracClient::TYPE_TRANSACTION_MOUTS => 'Moûts'), 'expanded'=>true)),
	...
	$sv12Contrat = $this->_sv12->contrats->add('SANSVITI'.str_replace('/', '-', $this->values['hashref']));
	...
	return $sv12Contrat;
      ...
      $sv12Contrat = $this->_sv12->contrats->add('SANSCONTRAT-'.$etablissement->identifiant.'-'.$this->values['raisinetmout'].str_replace('/', '-', $this->values['hashref']));
