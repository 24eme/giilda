<div id="contenu" style="background: #fff;">
	<section id="principal">
		...
		<a href="<?php echo url_for('drm_edition_detail', $detail); ?>" id="drm_export_details_annuler" class="btn_majeur btn_annuler drm_details_annuler">Annuler</a>
		<a href="#" id="drm_export_details_addTemplate" class="btn_majeur btn_modifier drm_details_addTemplate">Ajouter</a>
