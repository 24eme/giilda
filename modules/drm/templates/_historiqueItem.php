...
<?php if (!$valide): ?>
    ...
    <?php endif; ?>
    <td>
		<a href="<?php echo url_for('drm_init', array('identifiant' => $etablissement_identifiant, 'campagne_rectificative' => $campagne_rectificative)); ?>">Accéder à la déclaration en cours</a><br />
	   </td>
	   <td style="border: 0px; padding-left: 0px;background-color: #ffffff;">
	       <a href="<?php echo url_for('drm_delete', array('identifiant' => $etablissement_identifiant, 'campagne_rectificative' => $campagne_rectificative)); ?>" class="btn_reinitialiser"><span><img src="/images/pictos/pi_supprimer.png"/></span></a>
	   </td>
<?php else: ?>
	<td>OK</td>
    <?php if ($sf_user->hasCredential(myUser::CREDENTIAL_ADMIN)): ?>
