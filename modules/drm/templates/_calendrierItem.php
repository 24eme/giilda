<li>
    ...
    <?php elseif ($calendrier->getStatut($periode) == DRMCalendrier::STATUT_EN_COURS): ?>
        <ul class="mois_infos attente_campagne">
            ...
            <li><a href="<?php echo url_for('drm_init', array('identifiant' => $calendrier->getIdentifiant(), 'periode_version' => $calendrier->getPeriodeVersion($periode))); ?>">Términer la saisie</a><a href="<?php echo url_for('drm_delete', array('identifiant' => $calendrier->getIdentifiant(), 'periode_version' => $calendrier->getPeriodeVersion($periode))); ?>"> X </a></li>
        </ul>
