<table>
	...
	<tbody>
		...
		<tr class="alt">
			...
			<td>NOUVELLE</td>
			<td>
				<a href="<?php echo url_for('drm_nouvelle', array('identifiant' => $historique->geEtablissementIdentifiant(), 'campagne' => $futurDRM[DRMHistorique::VIEW_INDEX_ANNEE].'-'.$futurDRM[DRMHistorique::VIEW_INDEX_MOIS])) ?>">Démarrer la DRM</a><br />
			</td>
		</tr>
		<?php endif; ?>
