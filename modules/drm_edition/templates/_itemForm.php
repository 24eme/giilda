...
<div class="col_recolte<?php if ($active): ?> col_active<?php endif; ?>" data-input-focus="#drm_detail_sorties_vracsanscontrat" data-cssclass-rectif="<?php echo ($form->getObject()->getDocument()->isRectificative()) ? rectifierCssClass() : '' ?>">
...
<?php echo $form->getObject()->getLabelsLibelle() ?> <?php echo $form->getObject()->label_supplementaire ?> (&nbsp;<a href="<?php echo url_for("drm_edition_produit_addlabel", $form->getObject()) ?>" class="labels_lien" title="Choix du/des labels">éditer</a>&nbsp;)
            ...
            <div class="groupe" data-groupe-id="1">
                ...
                <ul>
                    ...
                    <li class="<?php if($key == 'revendique') echo "li_gris"; else echo isRectifierCssClass($form->getObject()->stocks_debut, $key); if ($key != 'revendique') { echo ' itemcache';} else { echo ' somme_stock_debut'; }  ?>">
            ...
            <div class="groupe p_gris" data-groupe-id="4">
                ...
                <ul>
                    ...
                    <li class="<?php echo isRectifierCssClass($form->getObject()->stocks_fin, $key); if($key == 'revendique') echo "li_gris"; ?>">
                        <?php if($key == 'revendique'): ?>
