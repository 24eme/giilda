...
\def\CONTRATVENDEURNOM{<?php echo display_latex_string($vrac->vendeur->nom,'',34); ?>}
...
\def\CONTRATVENDEURLIEU{<?php echo display_latex_string($vrac->vendeur->commune,'',34); ?>}

\def\CONTRATACHETEUREURNOM{<?php echo display_latex_string($vrac->acheteur->nom,'',33); ?>}
...
\def\CONTRATACHETEURLIEU{<?php echo display_latex_string($vrac->acheteur->commune,'',33); ?>}
...
\def\CONTRATDATEMAXENLEVEMENT{Au plus tard le<?php echo getPrefixPoint('07/09/1985',50); ?>}
\def\CONTRATFRAISDEGARDE{ <?php echo $vrac->getFraisDeGarde(); ?> ~ \euro/<?php echo showUnite($vrac) ?> }

\def\CONTRATLIEUCREATION{<?php echo getPrefixPoint($vrac->mandataire->commune,70); ?>}
\def\CONTRATDATECREATION{<?php echo getPrefixPoint($vrac->valide->date_saisie,70); ?>}
