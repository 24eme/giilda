...
<div class="bloc_form bloc_form_condensed">
    <div id="soussigne_recapitulatif_vendeur" class="<?php echoClassLignesVisu($cpt);
echoPictoSignature($societe, $vrac, 'Vendeur', $template_validation); ?>">
        <label>Vendeur :</label>
    ...
    <div id="soussigne_recapitulatif_acheteur" class="<?php echoClassLignesVisu($cpt);
echoPictoSignature($societe, $vrac, 'Acheteur', $template_validation); ?>">
...
<?php if (!$isTeledeclarationMode): ?>
        ...
        <?php endif; ?>
    <div id="soussigne_recapitulatif_mandataire" class="<?php echoClassLignesVisu($cpt);
        echoPictoSignature($societe, $vrac, 'Courtier', $template_validation); ?>" >
