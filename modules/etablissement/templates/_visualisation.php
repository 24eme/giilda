...
<?php if ($etablissement->getEmailTeledeclaration() && $etablissement->getSociete()->getMasterCompte()->isTeledeclarationActive()) : ?>
            <div class="form_ligne"> 
                <label for="teledeclaration_email">
                    Email de télédeclaration: 
                </label>
            <?php echo $etablissement->getEmailTeledeclaration(); ?>
            </div>  
        <?php endif; ?>
