...
<div id="operateur_infos" class="bloc_form">    
    <div class="col">
        ...
        <div class="ligne_form ligne_form_alt " >
            <span>
                ...
                <?php display_field($operateur,'no_tva_intracommunautaire'); ?>
            </span>
        </div>
    </div>
    ...
    <div class="col">
        <div class="ligne_form">
            <span>
                <label>Adresse</label>
                <?php display_field($operateur,'siege/adresse');  ?>
            </span>
        </div>
        <div class="ligne_form ligne_form_alt">
            <span>
                <label>CP*</label>
                <?php display_field($operateur,'siege/code_postal'); ?>
            </span>
        </div>
        <div class="ligne_form">
            <span>
                <label>Ville*</label>
                <?php display_field($operateur,'siege/commune'); ?>
            </span>
        </div>
    </div>
</div>