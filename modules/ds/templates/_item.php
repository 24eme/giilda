...
?>
    ...
    if (isset($prod_vol)) {
      ...
      if ($drm) {
	echo " <span>(<a href=\"" . url_for('drm_visualisation', array('identifiant' => $drm->identifiant, 'periode_version' => $drm->getPeriodeAndversion())) . "\">Vol. dernière DRM: $prod_vol</a>)</span>";
      }
    }
        ?></td>
    <td><?php
