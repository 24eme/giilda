...
echo -e "\n\n   DRM pour lesquelles une modificatrice dvrait être ouverte : \n\n" >> $RAPPORTBODY;
...
cat $RAPPORTBODY  | iconv -t ISO-8859-1 | mail -s "[RAPPORT RETOUR DOUANE de $APPLICATION du $DATEFORMAT]" $MAILFROMDOUANE $MAILRETOURDOUANE -a "Content-Type: text/plain; charset=ISO-8859-1";
