...
\rhead{\includegraphics[scale=1]{<?php echo realpath(dirname(__FILE__)."/../../../../../web/images")."/logo_". ($facture->exist('interpro') ? strtolower(str_replace("INTERPRO-", "", $facture->interpro)) : sfConfig::get('sf_app')) .".png"; ?>}}
\begin{document}
