...
\hspace*{0.5cm}
Produit : \textbf{\CONTRATAPPELLATIONPRODUIT} \small {\CONTRATLABELSPRODUIT} ~~ de la récolte : \textbf{\CONTRATMILLESIMEPRODUIT} <?php if ($vrac->cepage_libelle) { echo " - ".$vrac->cepage_libelle; } if ($vrac->cepage_85_15) { echo " - 85/15"; } ?> \\
\hspace*{0.5cm}
