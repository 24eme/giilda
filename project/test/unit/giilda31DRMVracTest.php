...
$t->is($mouvementVrac->origines[1], $drm_mod->_id.":".$mouvKeyOrigine1, "L'origine n°1 est ok");
$t->is($mouvementVrac->origines[0], $drm_mod->_id.":".$mouvKeyOrigine2, "L'origine n°2 est ok");
