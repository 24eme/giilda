...
sfConfig::set('app_teldeclaration_contact_contrat', array());
...
$t->ok(strpos($messages[0], "de INTERPRO : test_from_mail@mail.org") !== false, "Les infos de contact dans le mail sont bonnes");
