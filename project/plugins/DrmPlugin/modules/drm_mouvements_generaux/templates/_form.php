<form  class="popup_form" id="form_ajout" action="<?php echo url_for('drm_mouvements_generaux_product_ajout', $form->getDrm()->getOrAdd($certification_config->getHash())) ?>" method="post">
	...
	<div class="ligne_form_btn">
		<button name="annuler" class="btn_majeur btn_noir btn_fermer" type="reset">Annuler</button>
		<button name="valider" class="btn_majeur btn_etape_suiv" type="submit">Valider</button>
	</div>
</form>
