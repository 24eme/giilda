<nav class="navbar navbar-default ">
    <ul class="nav navbar-nav">
        <li class="<?php if($sf_request->getParameter('action') == 'infos'): ?>active<?php endif; ?>"><a href="<?php echo url_for("subvention_infos", $subvention) ?>"><span>Informations</span></a></li>
        <li class="<?php if($sf_request->getParameter('action') == 'dossier'): ?>active<?php endif; ?>"><a href="<?php echo url_for("subvention_dossier", $subvention) ?>"><span>Dossier</span></a></li>
