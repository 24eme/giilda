...
Numéro de dossier (facultatif): <?php if($subvention->numero_archive): echo $subvention->numero_archive; endif; ?> \bigbreak Version du dossier : \begin{todolist}[itemsep=1pt,parsep=1pt] \item<?php if($subvention->version == 1): ?>[\done]<?php endif; ?> initiale \item<?php if($subvention->version > 1): ?>[\done]<?php endif; ?> modifiée \end{todolist}  \\
\hline
