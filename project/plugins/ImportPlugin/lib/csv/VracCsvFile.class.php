...
class VracCsvFile extends CsvFile {
    ...
    const CSV_CLE_DELAI_PAIEMENT = 26;
    const CSV_DELAI_PAIEMENT = 27;
    const CSV_ACOMPTE_SIGNATURE = 28;
    const CSV_MOYEN_PAIEMENT = 29;
    const CSV_TAUX_COURTAGE = 30;
    const CSV_REPARTITION_COURTAGE = 31;
    const CSV_REPARTITION_CVO = 32;
