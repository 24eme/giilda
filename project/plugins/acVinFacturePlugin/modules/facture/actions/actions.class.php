...
class factureActions extends sfActions {
    ...
    public function executeIndex(sfWebRequest $request) {
        ...
        $this->generations = GenerationClient::getInstance()->findHistory(10, array(GenerationClient::TYPE_DOCUMENT_EXPORT_SHELL, GenerationClient::TYPE_DOCUMENT_FACTURES));
