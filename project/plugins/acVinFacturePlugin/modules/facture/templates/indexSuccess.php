...
<div class="row">
    <div class="col-xs-12">
        <h3>Générer toutes les factures <small>(<a href="<?php echo url_for('facture_en_attente'); ?>">mvts en attentes</a> | <a href="<?php echo url_for('facture_en_attente', ['only_mvts_next_facturation' =>  1, 'only_versionnes_factures' =>  1, 'versionnes' => 1]); ?>">mvts modifiés</a>)</small></h3>
