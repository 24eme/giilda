...
<div class="form-group line mvt_ligne" >
    <div class="col-xs-12">
        <div class="row">
            ...
            <div class="col-xs-4 <?php if($mvtForm["identifiant_analytique"]->hasError()): ?>text-danger<?php endif; ?>">
            ...
            <div class="col-xs-2 <?php if($mvtForm["libelle"]->hasError()): ?>text-danger<?php endif; ?>">
            ...
            <div class="col-xs-1 <?php if($mvtForm["prix_unitaire"]->hasError()): ?>text-danger<?php endif; ?>">
            ...
            <div class="col-xs-1 <?php if($mvtForm["quantite"]->hasError()): ?>text-danger<?php endif; ?>">
