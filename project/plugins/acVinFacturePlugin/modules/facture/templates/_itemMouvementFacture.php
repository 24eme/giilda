    ...
    <div class="col-xs-12">
        <div class="row">
            ...
            <div class="col-xs-3">
                ...
                <?php echo $mvt['libelle']->render(array('class' => 'form-control input-md text-right')); ?>  
            </div>
            <div class="col-xs-1">
                <?php echo $mvt['quantite']->renderError(); ?> 
                <?php echo $mvt['quantite']->render(array('class' => 'form-control input-md text-right')); ?>  
            </div>
            <div class="col-xs-1">
                <?php echo $mvt['prix_unitaire']->renderError(); ?> 
                <?php echo $mvt['prix_unitaire']->render(array('class' => 'form-control input-md text-right')); ?>  
            </div>
