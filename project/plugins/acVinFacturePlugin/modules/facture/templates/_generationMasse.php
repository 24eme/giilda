...
<form method="post" action="<?php echo $url_post; ?>" role="generationForm" class="form-horizontal">
        ...
        <div class="form-group <?php if ($generationForm["date_facturation"]->hasError()): ?>has-error<?php endif; ?>">
            ...
            <?php echo $generationForm["date_facturation"]->renderLabel("Date de facturation", array("class" => "col-xs-5 control-label")); ?>
            <div class="col-xs-7 date-picker">
        ...
        <div class="form-group <?php if ($generationForm["date_mouvement"]->hasError()): ?>has-error<?php endif; ?>">
            ...
            <?php echo $generationForm["date_mouvement"]->renderLabel("Date de prise en compte des mouvements", array("class" => "col-xs-5 control-label")); ?>
            <div class="col-xs-7 date-picker">
