...
class ExportFactureRelanceCSV {
    ...
    public static function getHeaderCsv() {
        return "Date de relance;Numéro relance;Nieme Relance;Identifiant;Raison Sociale;Adresse;Adresse complementaire;Commune;Code postal;SIRET;Numero d'adhérent;Code comptable;Numéro facture;Date de facture;Montant TTC;Montant Du;Facture doc ID\n";
    }
