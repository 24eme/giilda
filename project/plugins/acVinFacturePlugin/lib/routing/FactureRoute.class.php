...
class FactureRoute extends sfObjectRoute {
    ...
    protected function getObjectForParameters($parameters) {
        ...
        if (sfContext::getInstance()->getUser()->isAdmin() === false && sfContext::getInstance()->getUser()->hasTeledeclaration() && sfContext::getInstance()->getUser()->getCompte()->id_societe != $this->facture->getSociete()->_id) {
