...
class GenerationRelancePDF extends GenerationPDF {
    ...
    public function preGeneratePDF() {
        ...
        $etablissementsViews = EtablissementAllView::getInstance()->findByInterproStatutAndFamilles('INTERPRO-inter-loire', EtablissementClient::STATUT_ACTIF, array(EtablissementFamilles::FAMILLE_PRODUCTEUR,EtablissementFamilles::FAMILLE_NEGOCIANT));
