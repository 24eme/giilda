function(doc) {
     ...
     if (doc.interpros_metas) {
       for(interpro in doc.interpros_metas) {
     		var metas = doc.interpros_metas[interpro];
        emit([interpro,
              doc.statut,
              doc.type_societe,
              doc._id,
              doc.identifiant],
             [(metas.code_comptable_client)? metas.code_comptable_client : doc.code_comptable_client,
