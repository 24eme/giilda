...
class SocieteModificationForm extends acCouchdbObjectForm {
    ...
    public function configure() {
        ...
        $this->setWidget('type_numero_compte', new sfWidgetFormChoice(array('choices' => $this->getTypesNumeroCompte())));
        ...
        $this->setValidator('type_numero_compte', new sfValidatorChoice(array('required' => true, 'choices' => array_keys($this->getTypesNumeroCompte()))));
