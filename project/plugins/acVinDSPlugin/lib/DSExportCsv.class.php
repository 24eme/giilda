    ...
    public function exportDS($ds) {
        ...
        foreach($ds->declaration as $hash => $produit) {
          ...
          foreach($produit->detail as $key => $stocks) {
            ...
            $stocks->stock_declare_millesime_precedent.";".
            $stocks->dont_vraclibre_millesime_precedent.";".
