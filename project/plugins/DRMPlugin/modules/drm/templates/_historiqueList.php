<table>
	...
	<tbody>
		...
		<tr class="alt">
			...
			<td>NOUVELLE</td>
			<td>
				<a href="<?php echo url_for('drm_nouvelle', array('campagne' => $futurDRM[DRMHistorique::VIEW_INDEX_ANNEE].'-'.$futurDRM[DRMHistorique::VIEW_INDEX_MOIS], 'identifiant' => $historique->getIdentifiant())) ?>">Démarrer la DRM</a><br />
			</td>
		</tr>
		<?php endif; ?>
