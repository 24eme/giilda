...
class ConfigurationDetailLigne extends BaseConfigurationDetailLigne {
    ...
    public function needDouaneObservation($negoce = false) {
        ...
        return (!$negoce)? preg_match('/achats-reintegrations|autres-entrees|autres-sorties|replacement-suspension|manipulations/', $this->douane_cat) :
    ...
    public function needDouaneDateReplacement() {
        ...
        return preg_match('/achats-reintegrations|replacement-suspension/', $this->douane_cat);
    }
