function(doc) {
	...
	var mouv_hash = (mouv.produit_hash)? mouv.produit_hash : mouv.identifiant_analytique;
        ...
        emit([mouv.facture, mouv.facturable, region, identifiant, doc.type,categorie , mouv_hash, doc.periode, mouv.vrac_numero, mouv.vrac_destinataire, type_hash , mouv.detail_identifiant], [mouv_produit_libelle , type_libelle, mouv_volume, mouv_prix, mouv.date, mouv.vrac_destinataire, mouv.detail_libelle, doc.type+'-'+doc.identifiant+'-'+doc.periode, doc._id+':'+key]);
         } 
    }
 }
