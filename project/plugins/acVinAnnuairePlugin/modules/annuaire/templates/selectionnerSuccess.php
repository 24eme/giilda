...
<section id="principal">
  <ol class="breadcrumb">
    ...
    <li><a href="<?php echo url_for('annuaire', array('identifiant' => $etablissementPrincipal->identifiant)); ?>" class="active">Annuaire</a><?php echo getPointAideHtml('vrac','annuaire_fil_saisi_retour_annuaire'); ?></li>
		...
		<form id="principal" method="post" action="<?php echo url_for('annuaire_selectionner', array('identifiant' => $identifiant, 'acteur' => $acteur, 'isVendeur' => $isVendeur)); ?><?php if (isset($redirect)): ?>?redirect=<?php echo $redirect ?><?php endif; ?>">
