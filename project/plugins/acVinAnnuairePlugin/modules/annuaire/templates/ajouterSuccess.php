...
<section id="principal">
  ...
  <h2>Ajouter un contact</h2>
        <form id="principal" method="post" action="<?php echo url_for('annuaire_ajouter', array('identifiant' => $identifiant, 'type' => $type, 'tiers' => $societeId, 'acteur' => $acteur, 'isVendeur' => $isVendeur)) ?>">
