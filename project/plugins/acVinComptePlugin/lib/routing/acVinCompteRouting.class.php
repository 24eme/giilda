...
class acVinCompteRouting {
    ...
    static public function listenToRoutingLoadConfigurationEvent(sfEvent $event) {
        ...
        $r->prependRoute('compte_teledeclarant_modification_id', new SocieteRoute('/teledeclarant/mon_compte/:identifiant', array('module' => 'compte_teledeclarant', 'action' => 'modification'), array('sf_method' => array('get', 'post')), array('model' => 'Compte', 'type' => 'object')));
