<div class="text-center">
    <address class="<?php if (!isset($smallBlock) || !$smallBlock): ?>lead<?php endif ?>">
        ...
        <span <?php if($compte->insee): ?>title="<?php echo $compte->insee ?>"><?php echo $compte->code_postal; ?></span><?php endif; ?> <?php echo $compte->commune; ?> <small class="text-muted">(<?php echo $compte->pays; ?>)</small>
    </address>
</div>
