...
<section class="col-xs-3">
	...
	<div class="col-xs-12">
        ...
        <div class="input-group">
            <input id="creer_tag" name="tag" class="form-control" type="text" placeholder="Saisir le nom du tag" />
			<span class="input-group-btn">
	...
	<div class="col-xs-12">
        ...
        <div class="input-group">
            <select id="suppr_tag" placeholder="Sélectionner un tag" name="tag" class="form-control select2">
            	<option value=""></option>
