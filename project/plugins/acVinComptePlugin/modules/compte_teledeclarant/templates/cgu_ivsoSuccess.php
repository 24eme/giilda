        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo url_for("compte_teledeclarant_cgu") ?>" method="post">
                    ...
                    <p>
                        Pour activer votre espace de téléclaration, vous devez prendre connaissance et accepter la convention d'adhésion aux télédéclarations avec l'IVSO :  <a target="_blank" href="/pdf/convention_adhesion_ivso.pdf">consulter la convention d'adhésion</a>.
                        <br /><br />
                    </p>
                    ...
                    <div class="checkbox">
                      <label>
                        ...
                        J'accepte la <a target="_blank" href="/pdf/convention_adhesion_ivso.pdf">convention d'adhésion</a> aux télédéclarations
                      </label>
                    </div>
                    <div class="row" >
