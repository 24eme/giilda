        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo url_for("compte_teledeclarant_cgu") ?>" method="post">
                    ...
                    <p>
                        Pour activer votre espace de téléclaration, vous devez prendre connaissance et accepter la <a target="_blank" href="/pdf/convention_adhesion_ivbd.pdf">convention d'adhésion</a> aux télédéclarations avec l'IVBD :  <a target="_blank" href="/pdf/convention_adhesion_ivbd.pdf">consulter la convention</a>.
                        <br /><br />
                    </p>
