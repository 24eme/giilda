<ol class="breadcrumb">
    <li class="visited"><a href="<?php echo url_for('statistiques') ?>">Statistiques</a></li>
    <li class="active"><a href="<?php echo url_for('statistiques_vrac') ?>" class="active">Contrats</a></li>
</ol>
