...
<div class="row" id="statistiques">
    ...
    <?php endif; ?>
            ...
            <div id="bloc_periode" class="form-group bloc_conditionner" data-condition-value="exportations|disponibilites_stocks|sorties_categorie|sorties_appellation|stocks|controle_facturation|volumes_factures">
