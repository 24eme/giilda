              ...
              <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                  ...
                  <?php else : ?>
                    ...
                    <li><a href="<?= url_for('vrac_nouveau', ['choix-etablissement' => $etablissementVendeur->identifiant, 'vrac[isVendeur]' => true]); ?>"><?php if($etablissementVendeur->isViticulteur()): ?><strong><?php endif; ?>Manuellement en tant que vendeur<?php if ($etablissementAcheteur->isNegociant() && $etablissementVendeur->isViticulteur() && $etablissementAcheteur->identifiant != $etablissementVendeur->identifiant): ?> - Chai Production<?php endif; ?><?php if($etablissementVendeur->isViticulteur()): ?></strong><?php endif; ?></a></li>
                    ...
                    <li><a href="<?= url_for('vrac_nouveau', ['choix-etablissement' => $etablissementAcheteur->identifiant, 'vrac[isVendeur]' => true]); ?>"><strong>Manuellement en tant que vendeur - Chai Négoce</strong></a></li>
                    <?php endif; ?>
                  <?php endif; ?>
