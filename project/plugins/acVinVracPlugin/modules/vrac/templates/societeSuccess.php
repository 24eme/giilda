              ...
              <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                  ...
                  <?php else : ?>
                    ...
                    <li><a href="<?= url_for('vrac_nouveau', ['choix-etablissement' => $etablissementAcheteur->identifiant, 'vrac[isVendeur]' => true]); ?>">Manuellement en tant que vendeur - Chai Négoce</a></li>
                    <?php endif; ?>
                  <?php endif; ?>
