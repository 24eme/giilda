...
<?php if($isIGP): ?>\includegraphics[scale=0.45]{<?php echo realpath(dirname(__FILE__)."/../../../../../web/data")."/vinIGP_logo.jpg"; ?>}<?php else: ?>\includegraphics[scale=0.8]{<?php echo realpath(dirname(__FILE__)."/../../../../../web/data")."/logo_vrac_pdf.jpg"; ?>}<?php endif; ?>} & \multicolumn{2}{c|}{Numéro d'enregistrement} \\
