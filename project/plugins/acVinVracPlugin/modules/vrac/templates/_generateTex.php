...
\AddToShipoutPicture{%
\AtLowerLeftCorner{0.75cm}{-12cm}{\ifodd\c@page\rotatebox{90}{\begin{minipage}{\paperheight} \centering <?php if($vrac->isProduitIGP()): ?>AOÛT 2016<?php else: ?>AOÛT 2017<?php endif; ?>\end{minipage}}\fi}
}
\makeatother
