...
\begin{center}
\begin{large}
\textbf{REGLEMENTATION GENERALE DES TRANSACTIONS}
\end{large}
\\
...
La D.R.M. (ou la D.R.A.) devra indiquer, de façon lisible, les stocks de début et de fin de mois ainsi que les entrées et sorties ventilées par appellation et par couleur.\\
Pour chaque enlèvement correspondant à une vente au négoce, il doit être précisé sur la D.R.M. (ou sur la D.R.A.) le numéro d’enregistrement du contrat d’achat en propriété, la date et le volume enlevé. Ce numéro doit être reporté dans la comptabilité matière (registre de cave).
...
Les cotisations sont assises sur les volumes effectivement sortis de l’entrepôt suspensif de droits d’accises, repris sur les D.R.M. ou les D.R.A. s’il y a lieu.\\
Dans le cas d’une vente hors CRD à un négociant situé dans l’aire de production du ressort d’InterLoire, la cotisation est payée par moitié par le producteur et par moitié par le négociant. Dans tous les autres cas, la cotisation interprofessionnelle est payée en totalité par le viticulteur.\\
Néanmoins, dans le cas d’une vente de raisins et moûts à un négociant vinificateur, si le principe reste la répartition de la cotisation pour moitié par le producteur et par le négociant, la cotisation  est payée à InterLoire en totalité par le négociant. \\
Suite aux achats de raisins et moûts des négociants vinificateurs, la facturation des cotisations interprofessionnelles est basée sur la présentation de la copie ou d’une édition de la déclaration de production SV 12  sur la base des volumes réels obtenus et revendiqués.\\
Les négociants vinificateurs transmettent à InterLoire la copie ou une édition de la déclaration de production SV12 dans le délai prévu à l’article 16 paragraphe 1 du règlement (CE) n°436/2009 de la Commission du 26 mai 2009 soit, au plus tard le 15 janvier de l’année suivant la récolte.\\
Le délai de règlement de la cotisation interprofessionnelle est fixé à 60 jours fin de mois.\\
