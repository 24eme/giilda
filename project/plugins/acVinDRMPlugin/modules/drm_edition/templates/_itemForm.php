...
?>
<div <?php echo (!$detail->hasMovements()) ? 'style="display: none;"' : ''; ?> data-hash="<?php echo $detail->getHash() ?>" class="col_recolte<?php if ($active): ?> col_active<?php endif; ?> <?php echo ($detail->isEdited()) ? 'col_edited' : '' ?>" data-input-focus="#drm_detail_sorties_vracsanscontrat" data-cssclass-rectif="<?php echo ($form->getObject()->getDocument()->isRectificative()) ? VersionnerCssClass() : '' ?>">
            ...
            <div class="groupe" data-groupe-id="1">
                ...
                <ul>
                    <?php foreach ($form['stocks_debut'] as $key => $subform): ?>
                        <li class="<?php if ($key == 'revendique') echo "li_gris";
