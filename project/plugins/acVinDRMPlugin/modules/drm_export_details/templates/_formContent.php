...
<table id="drm_export_details_table" class="table table-striped">
    ...
    <tfoot>
        <tr>
            ...
            <td class="col-xs-2 typedoc_show"  <?php echo ($docShow)? '' : 'style="display: none;"' ?>  ></td>
            <td class="text-right col-xs-2"><button data-container="#drm_export_details_table tbody" data-template="#template_export" class="btn btn-xs btn-default dynamic-element-add"><span class="glyphicon glyphicon-plus"></span></button><?php echo getPointAideHtml('drm','mouvements_contrats_ajouter') ?></td>
        </tr>
    </tfoot>
</table>
