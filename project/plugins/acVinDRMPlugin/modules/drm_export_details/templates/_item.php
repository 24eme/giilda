...
<tr id="<?php echo $ligneId ?>">
    ...
    <td class="text-right col-xs-2">
        <button type="button" data-line="#<?php echo $ligneId ?>" data-add="#drm_export_details_table .dynamic-element-add" data-lines="#drm_export_details_table tbody tr" tabindex="-1" class="btn btn-xs btn-danger dynamic-element-delete"><span class="glyphicon glyphicon-remove"></span></button><?php echo getPointAideHtml('drm','mouvements_contrats_supprimer') ?>
    </td>
</tr>
