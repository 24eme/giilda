	...
	<tbody>
		...
		<?php foreach($details as $detail): ?>
			<tr>
				...
				<td class="<?php echo isVersionnerCssClass($detail, 'total_debut_mois') ?>"><?php if($hasDontRevendique && $detail->stocks_debut->exist('dont_revendique')): ?>(<?php echoFloat($detail->stocks_debut->dont_revendique) ?>&nbsp;<span class="unite">hl</span>) <?php endif; ?></td>
				...
				<td class="<?php echo isVersionnerCssClass($detail, 'total') ?>"><?php if($hasDontRevendique && $detail->stocks_fin->exist('dont_revendique')): ?>(<?php echoFloat($detail->stocks_fin->dont_revendique) ?>&nbsp;<span class="unite">hl</span>) <?php endif; ?></td>
			</tr>
		<?php endforeach; ?>
	</tbody>
</table>
