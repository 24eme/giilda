		...
		<?php foreach($details as $detail): ?>
			<tr>
				<td><?php echo $detail->getLibelle(ESC_RAW) ?></td>
                                <td class="<?php echo isVersionnerCssClass($detail, 'total_debut_mois') ?>"><strong><?php echoFloat($detail->total_debut_mois) ?></strong>&nbsp;<span class="unite">hl</span>&nbsp;(<?php echoFloat($detail->stocks_debut->revendique) ?>&nbsp;<span class="unite">hl</span>)</td>
				...
				<td class="<?php echo isVersionnerCssClass($detail, 'total') ?>"><strong><?php echoFloat($detail->total) ?></strong>&nbsp;<span class="unite">hl</span>&nbsp;(<?php echoFloat($detail->stocks_fin->revendique) ?>&nbsp;<span class="unite">hl</span>)</td>
			</tr>
		<?php endforeach; ?>
	</tbody>
</table>
