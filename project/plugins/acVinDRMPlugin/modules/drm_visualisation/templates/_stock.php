...
<table class="table table-striped table-condensed">
	<thead>
		<tr>
			...
			<th class="col-xs-1 text-right">Entrées</th><th class="col-xs-1">&nbsp;(Rev.)</th>
			<th class="col-xs-1 text-right">Sorties</th><th class="col-xs-1"><?php if(!$isTeledeclarationMode): ?>&nbsp;(Rev.)<?php endif; ?></th>
