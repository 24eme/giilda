...
<div id="contenu_onglet">
    ...
    <table id="table_drm_cvo_recap" class="table_recap">
        <thead >
            <tr>                        
                <th>&nbsp;</th>
                <th>Volumes facturables&nbsp;<a href="" class="msg_aide_drm" title="<?php echo getHelpMsgText('drm_visualisation_aide2'); ?>"></a></th>
<?php if($recapCvo->totalVolumeReintegration) : ?> 
               <th>Volumes réintégrés</th>
<?php endif; ?>
                <th>Montant&nbsp;<a href="" class="msg_aide_drm" title="<?php echo getHelpMsgText('drm_visualisation_aide3'); ?>"></a></th>
            </tr>
        </thead>
        ...
        <table id="table_droit_circulation" class="table_recap">
            <thead >
                <tr>             
                    <th>Libellé</th>
                    <th>Code</th>
                    <th>Volumes imposables&nbsp;<a href="" class="msg_aide_drm" title="<?php echo getHelpMsgText('drm_visualisation_aide4'); ?>"></a></th>
                    <th>Taux&nbsp;<a href="" class="msg_aide_drm" title="<?php echo getHelpMsgText('drm_visualisation_aide5'); ?>"></a></th>
                    <th>Montant&nbsp;<a href="" class="msg_aide_drm" title="<?php echo getHelpMsgText('drm_visualisation_aide6'); ?>"></a></th>
