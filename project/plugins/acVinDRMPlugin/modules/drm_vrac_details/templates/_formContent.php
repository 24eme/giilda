...
<table id="drm_vrac_details_table" class="table table-striped <?php echo ($docShow) ? 'typedoc_show' : 'typedoc_unshow'; ?>">
    ...
    <tfoot>
        <tr>
            ...
            <td class="text-right col-xs-2"><button data-container="#drm_vrac_details_table tbody" data-template="#template_vrac" class="btn btn-xs btn-default dynamic-element-add"><span class="glyphicon glyphicon-plus"></span></button><?php echo getPointAideHtml('drm','mouvements_contrats_ajouter') ?></td>
        </tr>
    </tfoot>
</table>
