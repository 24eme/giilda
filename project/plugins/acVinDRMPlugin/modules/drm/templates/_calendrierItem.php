                        ...
                        <div class="etablissement_tooltip">
                            ...
                            <?php if (hasALink($isTeledeclarationMode, $calendrier, $periode, $etb->etablissement)) : ?> 
                                <a href="<?php echo getEtatDRMHrefCalendrier($isTeledeclarationMode, $calendrier, $periode, $etb->etablissement); ?>"
                                   class="action <?php if (hasPopup($isTeledeclarationMode, $calendrier, $periode, $etb->etablissement)): echo 'drm_nouvelle_teledeclaration';
                    endif;
                                ?>"><?php echo getEtatDRMLibelleCalendrier($calendrier, $periode, $etb->etablissement); ?></a>
        <?php endif; ?> 
                        </div>
                    </li>                  
    <?php endforeach; ?>
