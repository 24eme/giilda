...
<div style="display:none;">
    <div id="legal_signature" class="legal_signature_content">
        <form action="<?php echo url_for('drm_legal_signature', array('identifiant' => $etablissement->identifiant)) ?>" method="post">
            ...
            <br/>
            <p>
                Votre Interprofession met à votre disposition des outils de simplification administrative sur le système d’identification sécurisé : « xxxxxxxx.pro ».
            </p>
            <p>
                Depuis le 1er novembre 2016, la télédéclaration de la DRM est disponible.
            </p>
              <br/>
            <p>
            ...
            <br/>
            <p>
                Pour activer votre espace DRM, vous devez prendre connaissance et accepter le contrat d’inscription à la télédéclaration de la DRM. Pour cela, <a href="/data/contrat_service_v1.pdf" style="text-decoration: underline;">cliquez ici</a>.
            </p>
            <br/>
