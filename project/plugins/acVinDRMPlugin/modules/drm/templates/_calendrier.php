...
<div class="section_label_maj <?php echo ($isTeledeclarationMode) ? 'section_label_maj_teledeclaration_drm' : '' ?>" id="calendrier_drm">
    ...
    <?php if ($sf_user->hasFlash('drm_neant_error')) : ?>
        <p style="background: #ffcece; border: 1px solid #ff0000; padding: 1px 5px; margin-top: 10px;"><?= $sf_user->getFlash('drm_neant_error') ?></p>
    <?php endif ?>
    <div class="bloc_form">
