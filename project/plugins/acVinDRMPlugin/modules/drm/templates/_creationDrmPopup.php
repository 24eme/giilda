                    ...
                    <div class="row">
                        ...
                        <div class="ligne_form type_creation" id="type_creation_div_<?php echo $periode . '_' . $identifiant; ?>" >
                            ...
                            <ul class="list-unstyled">
                                ...
                                <?php endif; ?>
                                    <li class="col-xs-10 col-xs-offset-1">
                                            <input type="radio" <?php if(!DRMConfiguration::getInstance()->getRepriseDonneesUrl()): ?>checked="checked"<?php endif; ?> id="drmChoixCreation_type_creation_<?php echo DRMClient::DRM_CREATION_VIERGE.'_'.$periode . '_' . $identifiant; ?>" value="<?php echo DRMClient::DRM_CREATION_VIERGE; ?>" name="drmChoixCreation[type_creation]">&nbsp;<label for="drmChoixCreation_type_creation_<?php echo DRMClient::DRM_CREATION_VIERGE.'_'.$periode . '_' . $identifiant; ?>">Création d'une drm vierge <?php if(DRMConfiguration::getInstance()->getRepriseDonneesUrl()): ?><small>(avec les produits de la DRM précédente)</small><?php endif; ?></label>
                                                <div class="pull-right"><?php echo getPointAideHtml('drm','creation_nouvelle') ?></div>
                                    </li>
                                    <li class="col-xs-10 col-xs-offset-1" >
