                    ...
                    <ul class="list-unstyled">
                      <?php if(DRMConfiguration::getInstance()->getRepriseDonneesUrl()): ?>
                        <li class="col-xs-10 col-xs-offset-1">
							<div class="radio">
							  <label>
							    <input type="radio" checked="checked" id="drmChoixCreation_type_creation_<?php echo DRMClient::DRM_CREATION_DOCUMENTS; ?>" value="<?php echo DRMClient::DRM_CREATION_DOCUMENTS; ?>" name="drmChoixCreation[type_creation]">
							    Création d'une drm pré-remplie
							  </label>
                      ...
                      <?php else: ?>
                        <li class="col-xs-10 col-xs-offset-1">
							<div class="radio">
							  <label>
							    <input type="radio" checked="checked" id="drmChoixCreation_type_creation_<?php echo DRMClient::DRM_CREATION_VIERGE; ?>" value="<?php echo DRMClient::DRM_CREATION_VIERGE; ?>" name="drmChoixCreation[type_creation]">
							    Création d'une drm vierge
							  </label>
							  <div class="pull-right"><?php echo getPointAideHtml('drm','creation_nouvelle') ?></div>
							</div>
                        </li>
                      <?php endif; ?>
                        ...
                        <li class="col-xs-10 col-xs-offset-1" >
							<div class="radio">
							  <label>
							    <input type="radio" id="drmChoixCreation_type_creation_<?php echo DRMClient::DRM_CREATION_NEANT; ?>" value="<?php echo DRMClient::DRM_CREATION_NEANT; ?>" name="drmChoixCreation[type_creation]">
							    Création d'une drm à néant
							  </label>
                      ...
                      <li class="col-xs-10 col-xs-offset-1" >
						<div class="radio">
						  <label>
						    <input type="radio" id="drmChoixCreation_type_creation_<?php  echo DRMClient::DRM_CREATION_EDI; ?>" value="CREATION_EDI" name="drmChoixCreation[type_creation]">
						    Création depuis un logiciel tiers
						  </label>
