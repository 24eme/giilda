...
<section id="principal" class="drm">
    ...
    <section id="contenu_etape">
        ...
        <fieldset id="historique_drm"> 
            ...
            <?php include_component('drm', 'calendrierStatic', array('etablissement' => $etablissement, 'campagne' => $campagne, 'formCampagne' => $formCampagne, 'isTeledeclarationMode' => $isTeledeclarationMode)); ?>
        </fieldset>
    </section>
    <!-- fin #contenu_etape -->
