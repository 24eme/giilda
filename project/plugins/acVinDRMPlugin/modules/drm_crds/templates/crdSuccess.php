                                ...
                                <tbody class="drm_crds_list">
                                    <?php foreach ($crds as $crdKey => $crd): ?>
                                        <tr class="crd_row" id="<?php echo str_replace('.', '', $regime . '_' .$crdKey); ?>">
                                            ...
                                            <td class="crds_debut_de_mois  text-center vertical-center"><?php if ($crd->stock_debut && !$drm->isDebutCampagne()) { echo $crd->stock_debut; } else { echo $crdsForms['stock_debut_' . $regime . '_' . $crdKey]->render(); }; ?></td>
