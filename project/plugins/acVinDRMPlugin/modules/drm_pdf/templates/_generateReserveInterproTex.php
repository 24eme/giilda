...
$produits = $drm->getProduitsReserveInterpro();
 ...
 if (count($produits)) : ?>
    ...
    <?php foreach ($produits as $produit): ?>
        ...
        \multicolumn{1}{|r|}{\small{\textbf{<?php echoFloatWithHl($produit->getVolumeCommercialisable()); ?>}}}
        \\
        \hline
