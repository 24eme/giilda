...
function xmlProduitLibelle($produit) {
	return "<![CDATA[".preg_replace('/&([^#])/', ' et \1', trim(html_entity_decode((($produit->produit_libelle) ? $produit->produit_libelle : $produit->getLibelle('%format_libelle% %la%')), ENT_QUOTES | ENT_HTML401)))."]]>";
}
