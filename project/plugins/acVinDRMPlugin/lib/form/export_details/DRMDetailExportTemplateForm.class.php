...
class DRMDetailExportTemplateForm extends DRMDetailExportForm {
    ...
    public function configure() {
        $newExport = DRMESDetailExport::freeInstance($this->details->getDocument());
        $item_form_class = $this->getFormItemClass();
        $this->embedForm('var---nbItem---', new $item_form_class($this->details->addDetail($newExport),array('isTeledeclarationMode' => $this->isTeledeclarationMode)));
