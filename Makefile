...
.views/vrac.json: project/config/databases.yml project/plugins/acVinVracPlugin/lib/model/Vrac/views/vrac.contratsFromProduit.map.view.js project/plugins/acVinVracPlugin/lib/model/Vrac/views/vrac.contratsFromProduit.reduce.view.js project/plugins/acVinVracPlugin/lib/model/Vrac/views/vrac.domaines.map.view.js project/plugins/acVinVracPlugin/lib/model/Vrac/views/vrac.domaines.reduce.view.js project/plugins/acVinVracPlugin/lib/model/Vrac/views/vrac.history.map.view.js project/plugins/acVinVracPlugin/lib/model/Vrac/views/vrac.history.reduce.view.js project/plugins/acVinVracPlugin/lib/model/Vrac/views/vrac.soussigneidentifiant.map.view.js project/plugins/acVinVracPlugin/lib/model/Vrac/views/vrac.soussigneidentifiant.reduce.view.js project/plugins/acVinVracPlugin/lib/model/Vrac/views/vrac.statutAndType.map.view.js project/plugins/acVinVracPlugin/lib/model/Vrac/views/vrac.statutAndType.reduce.view.js project/plugins/acVinVracPlugin/lib/model/Vrac/views/vrac.stocks.map.view.js project/plugins/acVinVracPlugin/lib/model/Vrac/views/vrac.stocks.reduce.view.js project/plugins/acVinVracPlugin/lib/model/Vrac/views/vrac.vracSimilaire.map.view.js project/plugins/acVinVracPlugin/lib/model/Vrac/views/vrac.vracSimilaire.reduce.view.js
...
.views/drm.json: project/config/databases.yml project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.stocks.map.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.all.reduce.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.all.map.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.produits.map.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.stocks.reduce.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.derniere.reduce.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.produits.reduce.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.derniere.map.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.ciel.map.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.ciel.reduce.view.js
	perl bin/generate_views.pl project/config/databases.yml project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.stocks.map.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.all.reduce.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.all.map.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.ciel.reduce.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.ciel.map.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.produits.map.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.stocks.reduce.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.derniere.reduce.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.produits.reduce.view.js project/plugins/acVinDRMPlugin/lib/model/DRM/views/drm.derniere.map.view.js > $@ || rm >@

.views/sv12.json: project/config/databases.yml project/plugins/acVinSV12Plugin/lib/model/SV12/views/sv12.all.map.view.js project/plugins/acVinSV12Plugin/lib/model/SV12/views/sv12.all.reduce.view.js
	perl bin/generate_views.pl project/config/databases.yml project/plugins/acVinSV12Plugin/lib/model/SV12/views/sv12.all.map.view.js project/plugins/acVinSV12Plugin/lib/model/SV12/views/sv12.all.reduce.view.js > $@ || rm >@
